  ...
  return (
    <div className="min-h-screen bg-white pb-24">
      ...
      <div className="flex flex-col items-center px-6 mt-4 gap-6">
        {/* Logo */}
        <div className="w-40 h-40 rounded-full border-4 border-red-400 flex items-center justify-center bg-yellow-400 overflow-hidden">
        ...
        <div className="w-full flex flex-col gap-3 mt-2">
          ...
          {admin?.super_admin && (
            <button
              onClick={() => router.push("/admin/account/kelola")}
              className="w-full py-4 bg-gray-200 hover:bg-gray-300 text-black text-lg rounded-2xl transition active:scale-95"
            >
              Kelola Admin
            </button>
          )}
          ...
          <button
            ...
            className="w-full py-4 bg-gray-200 hover:bg-gray-300 text-red-500 text-lg rounded-2xl transition active:scale-95"
          >
            Log Out
          </button>
        </div>
